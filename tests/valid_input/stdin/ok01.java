class Main {
    ...
    static void run() {
        ...
        ifj16.print(str + input1 + " - " +  input2 + " = " + proc_int.sub(input1, input2) + " nebo " + input2 +  " - " + input1 + " = " + proc_int.sub(input1, input2)+ "\n");	// odje torima
        ...
        ifj16.print(str + input2 +" / "+ input1 + " = " + proc_int.div(input2, input1)+ "\n");
		...
		input3 = ifj16.readDouble();
		input4 = ifj16.readDouble();
