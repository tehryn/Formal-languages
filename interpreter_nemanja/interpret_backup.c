			...
			while(postfix_array[k]->id!=-2)
			{
				...
				switch (ptr->id)
				{
					...
					case S_PLUS:					// ----------- PLUS
						...
						item_tmp1=(htab_item *)tmp1.ptr;
						item_tmp2=(htab_item *)tmp2.ptr;	
						...
						if (return_token->id==TYPE_DOUBLE)
						{
							...
							((htab_item *)new->ptr)->data=(void *)tmp_value;
							((htab_item *)new->ptr)->initialized=1;
						...
						if (return_token->id==TYPE_STRING)            //     STRING CONCATENATE
						{
							...
							((htab_item *)new->ptr)->data=(void *)str3;
							((htab_item *)new->ptr)->initialized=1;
							stack_expression_push(S,*new);
							break;
						}						
				...
				printf("ZAVRSIO SE CASE\n");
				
			}
			
			printf("ZAVRSIO SE WHILE\n");
